<template>
  <div class="card">
    ...
    <div class="confirm">
      <div class="loading-percentage">{{ loadingPercent }}%</div>
    ...
    <CmUpdate v-if="editMode" @close="editMode = false" />
      ...
      if (confirmation) {
        try {
          const response = await axios.delete(
            `https://localhost:7066/LearningCourse/${this.idCourse}`,
            {

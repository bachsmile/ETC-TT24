<template>
  <div class="flex flex-col gap-[32px] p-[24px]">
    <div class="mb-[20px]">
      ...
      <div>
        <h1 class="text-[#101828] text-[18px] leading-[28px] font-semibold my-[24px]">Đánh giá</h1>
        <div class="shadow-lg w-full rounded-[8px] overflow-hidden">
          <div class="bg-white py-[24px] px-[30px] flex items-center justify-center gap-[32px] w-full">
            <div class="flex-[0_0_30%] flex flex-col gap-[16px] items-center justify-center">
              <h1 class="text-[60px] font-semibold leading-[44px] tracking-[-2%] text-[#344054]">5</h1>
              ...
              <div class="text-[14px] leading-[20px] text-center text-[#1570EF] font-medium">99999 Đánh giá</div>
            </div>
            <div class="flex-[0_0_70%] flex flex-col gap-[16px] justify-center items-start">
              <CmProgess :ratio="60" star="5 sao" />
              <CmProgess :ratio="20" star="4 sao" />
              <CmProgess :ratio="7" star="3 sao" />
              <CmProgess :ratio="4" star="2 sao" />
              <CmProgess :ratio="9" star="1 sao" />
            </div>
          </div>
        </div>
        <div class="w-full text-center pt-4">
          <button class="bg-[#1570ef] text-white py-[10px] px-[16px] rounded-xl" @click="showCommen">
            Viết đánh giá
          </button>
        </div>

        <div v-show="isComment" class="p-8 rounded-[8px] bg-white shadow-md flex items-center gap-10 relative">
          <img
          ...
          <div class="w-[90%]">
            <div class="w-[100%] overflow-hidden relative mb-5">
              ...
              />
              <div class="absolute bg-blue-500 px-6 py-3 rounded-e-2xl top-0 right-0">
                <i class="fa-solid fa-paper-plane text-white text-[30px] h-full w-[100%]"></i>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            @click="showCommen"
          >
            <i class="text-[15px] text-black fa-solid fa-xmark group-hover:text-red-500"></i>
          </div>
        </div>
      </div>
    </div>
    <div class="flex justify-end">
      <button class="flex justify-center items-center gap-3 py-[8px] px-[14px] bg-[#EFF8FF] rounded-[8px]">
    ...
    <div class="flex flex-col justify-start gap-6">
      <CmComment
        ...
        :img-user="comment.imgUser"
        :name-user="comment.nameUser"
